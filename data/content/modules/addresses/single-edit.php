<template id="page-addresses-edit">
	<div>
				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>Modificar</strong> Direccion</h3>
							<ul class="panel-controls">
								<li>
									<router-link tag="a" :to="{ name: 'page-addresses-view', params: { address_id: $route.params.address_id } }" class="panel-remove" title="Cerrar" data-toggle="tooltip" data-placement="bottom">
						...
						<form id="jvalidate" role="form" class="form-horizontal-" action="javascript:alert('Form #validate2 submited');">
							...
							<div class="panel-body">
								<p class="list-group"><div class="list-group alert" id="messageBox"></div></p>
							</div>
							
							<div class="panel-footer">
								<button class="btn btn-danger pull-left" @click="delete_this()" type="button">Eliminar</button>
