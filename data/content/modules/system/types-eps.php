<template id="page-system-types-eps">
	<div>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>Sistema</strong> Tipos de EPS</h3>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" v-model="create.code" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">NIT</label>
												<div class="col-md-10">
													<input type="text" class="form-control" v-model="create.nit" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">Administradora</label>
												<div class="col-md-10">
													<input type="text" class="form-control" v-model="create.admin" />
												</div>
											</div>
											<div class="form-group">
									...
									<div class="panel panel-default" v-if="edit_enabled === true">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<label class="col-md-2 control-label">NIT</label>
												<div class="col-md-10">
													<input type="text" class="form-control" v-model="edit.nit" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">Administradora</label>
												<div class="col-md-10">
													<input type="text" class="form-control" v-model="edit.admin" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">Nombre</label>
