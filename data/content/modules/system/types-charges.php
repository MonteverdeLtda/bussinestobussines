<template id="page-system-types-charges">
	<div>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>Sistema</strong> Cargos de Empleados</h3>
									...
									<div class="panel panel-default" v-if="edit_enabled === true">
										...
										<div class="panel-body">
											<div class="form-group">
												<label class="col-md-2 control-label">Código</label>
												<div class="col-md-10">
													<input id="boxEdit-inputCode" type="text" class="form-control" v-model="edit.code" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">Nombre</label>
