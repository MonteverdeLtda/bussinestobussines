				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<ul class="panel-controls">
								<li>
									<a data-toggle="tooltip" data-placement="bottom" title="Eliminar Cuenta" @click="delete_this();">
						...
						<form id="jvalidate" role="form" class="form-horizontal-" action="javascript:alert('Form #validate2 submited');">
							...
							<div class="panel-footer">
								...
								<button class="btn btn-primary pull-right" type="submit">Modificar Cuenta</button>
							</div>
							<div class="panel-footer">
								{{ post }}
							</div>
