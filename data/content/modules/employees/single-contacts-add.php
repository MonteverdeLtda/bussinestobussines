<template id="page-employees-single-contacts-add">
	<div>		
				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<ul class="panel-controls">
								<li>
									<router-link tag="a" :to="{ name: 'page-employees-single-contacts-list', params: { employee_id: $route.params.employee_id } }" class="panel-remove" title="Cerrar" data-toggle="tooltip" data-placement="bottom">
