<template id="page-employees-single-edit">
	<div>
			...
			<form id="jvalidate" role="form" class="form-horizontal" action="javascript:alert('Form #validate2 submited');">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Modificando Empleado</h3>
								<ul class="panel-controls">
									<li>
										<a @click="delete_employee()" type="button" class="panel-refresh" title="Eliminar" data-toggle="tooltip" data-placement="bottom">
											<span class="fa fa-trash"></span>
										</a>
									</li>
									<li>
										<router-link tag="a" :to="{ name: 'page-employees-single-view', params: { employee_id: $route.params.employee_id } }" class="panel-remove" title="Cerrar" data-toggle="tooltip" data-placement="bottom">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<select @change="changeCity()" class="form-control select" name="department" v-model="post.department" data-live-search="true">
																	<option value="null"></option>
																</select>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12">
																...
																<div class="icheckbox_minimal-grey" style="position: relative;">
																	<input name="eps_active" v-model="post.eps_active" type="checkbox" class="icheckbox"  style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 15%;" />
																</div> Activa
																</label>
															</div>
														</div>
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<label class="check">
																<div class="icheckbox_minimal-grey" style="position: relative;">
																	<input name="arl_active" v-model="post.arl_active" type="checkbox" class="icheckbox"  style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 15%;" />
																</div> Activa
																</label>
															</div>
														</div>
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<label class="check">
																<div class="icheckbox_minimal-grey" style="position: relative;">
																	<input name="pension_fund_active" v-model="post.pension_fund_active" type="checkbox" class="icheckbox"  style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 15%;" />
																</div> Activa
																</label>
															</div>
														</div>
													...
													<div class="col-md-2">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<label class="check">
																<div class="icheckbox_minimal-grey" style="position: relative;">
																	<input name="compensation_fund_active" v-model="post.compensation_fund_active" type="checkbox" class="icheckbox"  style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 15%;" />
																</div> Activa
																</label>
															</div>
														</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<div class="input-group">
																	<span class="input-group-addon"><span style="color: black;" class="fas fa-signature"></span></span>
																	<input type="text" class="form-control mask_date" name="company_date_entry" v-model="post.company_date_entry" />
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<div class="input-group">
																	<span class="input-group-addon"><span style="color: black;" class="fas fa-signature"></span></span>
																	<input type="text" class="form-control mask_date" name="company_date_out" v-model="post.company_date_out" />
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<div class="input-group">
																	<span class="input-group-addon"><span style="color: black;" class="fas fa-signature"></span></span>
																	<input type="text" class="form-control mask_email" name="company_mail" v-model="post.company_mail" />
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<div class="input-group">
																	<span class="input-group-addon"><span style="color: black;" class="fas fa-signature"></span></span>
																	<input type="text" class="form-control mask_phone_ext" name="company_number_phone" v-model="post.company_number_phone" />
																</div>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="col-xs-12">
																<div class="input-group">
																	<span class="input-group-addon"><span style="color: black;" class="fas fa-signature"></span></span>
																	<input type="text" class="form-control mask_phone" name="company_number_mobile" v-model="post.company_number_mobile" />
																</div>
															</div>
														</div>
													</div>
											...
											<div class="panel-footer">
												<div class="row">
													...
													<div class="col-md-12 pull-right">
														<button class="btn btn-primary pull-right" type="submit">Guardar Cuenta</button>
													</div>
												</div>
											</div>
										</div>
